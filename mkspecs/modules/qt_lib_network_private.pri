QT.network_private.VERSION = 5.11.1
QT.network_private.name = QtNetwork
QT.network_private.module =
QT.network_private.libs = $$QT_MODULE_LIB_BASE
QT.network_private.includes = $$QT_MODULE_INCLUDE_BASE/QtNetwork/5.11.1 $$QT_MODULE_INCLUDE_BASE/QtNetwork/5.11.1/QtNetwork
...
QT.network_private.disabled_features = libproxy linux-netlink openssl openssl-linked
